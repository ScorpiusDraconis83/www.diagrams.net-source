...
* ``defaultTextStyle``: Default style for Text elements in sidebar, toolbar, menus and shape picker. Default value is ``text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;``.
